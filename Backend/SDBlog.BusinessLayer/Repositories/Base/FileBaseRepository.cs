...
namespace SDBlog.BusinessLayer.Services.Base
{
    public class FileBaseRepository<T> : IFileBaseRepository<T> where T : class
    {
        private readonly MainDbContext _mainDbContext;
        private readonly DbSet<T> _set;

        public FileBaseRepository(MainDbContext applicationDbContext)
        {
